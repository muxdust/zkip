...
const Hero = () => {
  return (
    <section className="flex justify-center items-center min-h-screen w-full bg-gradient-to-br from-zinc-800 to-zinc-900 font-[family-name:var(--font-urbanist)] relative">
      <div className="absolute h-20 w-32 bg-orange-600 rounded-full flex justify-center items-center z-0 blur-[100px] top-0"></div>
      <div className="flex flex-col justify-center items-center text-center w-full max-w-2xl px-4">
        ...
        <Link
          href="/login"
          className="mt-6 px-5 py-2 hover:opacity-90 bg-gradient-to-br from-orange-500 to-orange-700 text-zinc-100 rounded-full transition duration-300 ease-in-out cursor-pointer border border-orange-500 flex items-center justify-center"
        >
